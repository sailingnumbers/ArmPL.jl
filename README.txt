...
# About Julia bindings (libblastrampoline) to Arm Performance Libraries (BLAS).
This package is linking <libarmpl.so> usually symlinked to
<libarmpl_ilp64_mp.so>. Example location of <libarmpl.so> /
